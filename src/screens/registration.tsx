...
const RegistrationScreen = () => {
    const [isActivePolicyCheck, setIsActivePolicyCheck] = useState<boolean>(false);
        ...
        <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
            <ScrollView contentContainerStyle={styles.contentContainer} keyboardShouldPersistTaps="always">
                ...
                <View style={styles.inputContainer}>
                    <Input type="text" helperText="Ваше имя" />
                    <Input type="email" helperText="Email" />
                    <Input type="password" helperText="Пароль" />
                </View>
                <View style={styles.policyContainer}>
                    <TouchableOpacity style={styles.policyIconContainer} onPress={togglePolicyCheck}>
                        <Icon color={isActivePolicyCheck ? colors.block : colors.text} width={10} height={10} />
                    </TouchableOpacity>
                ...
                <View style={styles.loginButtonContainer}>
                    <Button title="Зарегистрироваться" isAccent paddingHorizontal={0.1} />
                </View>
                <View style={styles.loginContainer}>
                    <Text style={styles.loginText}>Есть аккаунт?
                    </Text>
