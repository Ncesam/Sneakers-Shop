...
import { StrengthOnboardingScreen, TravelOnboardingScreen, WelcomeOnboardingScreen } from "@screens/onboardings";
...
const OnboardingScreenArray: Array<React.FC> = [
    WelcomeOnboardingScreen, TravelOnboardingScreen, StrengthOnboardingScreen
]
    ...
    return (
        <GestureRecognizer onSwipeLeft={handleLeftSwipe} onSwipeRight={handleRightSwipe}>
            ...
            <View style={styles.buttonContainer}>
                <Button title={currentIndex === 0 ? "Начать" : "Далее"} onPress={handleLeftSwipe} />
            </View>
        </GestureRecognizer>
    )
}
